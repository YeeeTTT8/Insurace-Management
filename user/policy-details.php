...
<html lang="en">
 ...
 <meta name="description" content="Insuracare in PHP and MySQL">
    ...
    <title>Insuracare |    Policy Details </title>
...
<?php if($row['PolicyStatus']=="1"){ ?>
<a href="download-policy.php?pid=<?php  echo $pid;?>" title="Download Policy"> Download </a>
<?php } ?>
...
<?php if($row['PolicyStatus']=="1"){ ?>
<a href="download-policy.php?pid=<?php  echo $pid;?>" title="Download Policy" class="btn btn-info"> Download Policy </a>
<?php } ?>
                 </td>   
