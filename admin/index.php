...
<html lang="en">
  <head>
    ...
    <title>Insuracare | Admin Login</title>
  ...
  <body class="az-body" style="background-color:#007bff;">

    <div class="az-signin-wrapper">
      <div class="az-card-signin">
        <h1 class="az-logo">INSURACARE</h1>
   ...
   <p style="font-size:16px; color:red" align="center"> <?php if($msg){
    ...
    <input type="password" class="form-control" placeholder="Enter your password" name="password" required="true">
        ...
        <div class="az-signin-footer">
          ...
          <p>Back to Home Page <a href="../index.php">Click Here</a></p>
