...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8">B/w Dates Policy Report</h2>
        </div>
...
$tdate=$_POST['tdate'];
 ...
 ?>
         <div class="az-content-label mg-b-20" align="center"> Policy Report From <?php echo date("d-m-Y", strtotime($fdate));?> To <?php echo date("d-m-Y", strtotime($tdate));?></div>
...
where date(tblpolicyholder.PolicyApplyDate) between '$fdate' and '$tdate'");
$cnt=1;
