...
<html lang="en">
 ...
 <meta name="description" content="Insuracare in PHP and MySQL">
    ...
    <title>Insuracare |  Manage Category</title>
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="editcategory.php?editid=<?php echo $row['ID'];?>"class="btn btn-primary">Edit</a>
                      <a href="manage-categories.php?id=<?php echo $row['ID']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
