...
if($_GET['del']){
$catid=$_GET['id'];
mysqli_query($con,"delete from tblsubcategory where id ='$catid'");
...
<html lang="en">
 ...
 <meta name="description" content="Insuracare in PHP and MySQL">
    ...
    <title>Insuracare |  Manage SubCategory</title>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-subcategory.php?scid=<?php echo $row['subcatid'];?>" class="btn btn-primary">Edit</a>
                          <a href="manage-subcategories.php?id=<?php echo $row['subcatid']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
