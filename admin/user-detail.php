...
<html lang="en">
 ...
 <meta name="description" content="Insuracare in PHP and MySQL">
    ...
    <title>Insuracare |  Mange Use Detail</title>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-userprofile.php?userid=<?php echo $row['ID'];?>" class="btn btn-primary">Edit</a>
                    <a href="user-policies.php?userid=<?php echo $row['ID'];?>&&uname=<?php echo $row['FullName'];?>" class="btn btn-info" target="_blank">User Policies</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
