...
<html lang="en">
 ...
 <meta name="description" content="Insuracare in PHP and MySQL">
    ...
    <title>Insuracare |  Manage Policy Form</title>
...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8">Manage Insurance Policies !</h2>
        </div>
...
<p style="font-size:16px; color:red" alignment="center"> <?php if($msg){
    echo $msg;
  }  ?> </p>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-policyform.php?polid=<?php echo $row['ID'];?>" class="btn btn-primary">Edit</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
