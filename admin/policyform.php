...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblpolicy(CategoryId, SubcategoryId, PolicyName, Sumassured, Premium,Tenure,policyDetails) value('$catid','$subcat','$polname','$sumass','$pri','$tenure','$pdetails')");
    if ($query) {
echo "<script>alert('Policy created successfully');</script>";
echo "<script>window.location.href='manage-policyform.php'</script>";
  }else{
  echo "<script>alert('Something Went Wrong. Please try again');</script>";
echo "<script>window.location.href='policyform.php'</script>";
    }
...
<div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control wd-450" rows="8" required="true" name="policydetails"></textarea>
                </div> 
