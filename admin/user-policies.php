...
<html lang="en">
 ...
 <meta name="description" content="Insuracare in PHP and MySQL">
    ...
    <title>Insuracare |   User Policies </title>
...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8"> <?php echo $_GET['uname'];?>'s Policies</h2>
        </div>
     ...
     <div class="az-content">
      <div class="container">
        <div class="az-content-body">
          ...
          <div class="az-content-label mg-b-5">  <?php echo $_GET['uname'];?>'s Policies Details </div>
...
where tblpolicyholder.UserId='$uid'");
$cnt=1;
