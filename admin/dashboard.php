...
?>
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card card-dashboard-twentytwo">
              <div class="media">
                <div class="media-icon bg-pink"><i class="typcn typcn-th-menu"></i></div>
                <div class="media-body">
...
?>                
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card card-dashboard-twentytwo">
              <div class="media">
                <div class="media-icon bg-teal"><i class="typcn typcn-th-list"></i></div>
                <div class="media-body">
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
            <div class="card card-dashboard-twentytwo">
              <div class="media">
                <div class="media-icon bg-primary"><i class="typcn typcn-clipboard"></i></div>
                <div class="media-body">
                  <?php $ret=mysqli_query($con,"Select * from tblticket");
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card card-dashboard-twentytwo">
              <div class="media">
                ...
                <div class="media-body">
<?php $rt=mysqli_query($con,"Select * from tblticket where AdminRemark is null");
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card card-dashboard-twentytwo">
              <div class="media">
                ...
                <div class="media-body">
<?php $rw=mysqli_query($con,"Select * from tblticket where AdminRemark!=''");
